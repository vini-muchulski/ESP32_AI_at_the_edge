# ESP32-S3 CIFAR-10 (TensorFlow Lite Micro)

This project runs an INT8-quantized CIFAR-10 model on an ESP32-S3 and exposes inference over Wi-Fi (`POST /predict`).

## Results

Example outputs from `src/results/`:

![CIFAR-10 Inference Result](src/results/inference_result.png)

![CIFAR-10 Test 1](src/results/cifar10_test1_esp32.png)



![CIFAR-10 Summary](src/results/cifar10_results_esp32.png)
...
- Example result images and CSV output: `src/results/`
- Kaggle notebook: not available yet
...
- `POST /predict`
  - JSON body: `{"q_pixels": [3072 quantized values]}`
