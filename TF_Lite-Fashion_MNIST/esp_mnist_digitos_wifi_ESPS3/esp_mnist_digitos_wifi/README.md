# ESP32-S3 Fashion-MNIST (TensorFlow Lite Micro)

This project runs an INT8-quantized Fashion-MNIST model on an ESP32-S3 and exposes inference over Wi-Fi (`POST /predict`).

## Results

Example output image:

![Fashion-MNIST Inference Result](src/inference_result.png)
...
- Kaggle notebook (training/export reference): [fashion-mnist-small-model-tflite-int8](https://www.kaggle.com/code/vinimuchulski/fashion-mnist-small-model-tflite-int8)
